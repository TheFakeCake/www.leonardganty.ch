  ...
  return (
    <>
      <SEO
        ...
        description="La médecine traditionnelle chinoise comprend de nombreuses techniques, dont l’acupuncture, pour traiter autant de maux et problèmes."
      />
      ...
      <ContentRow tag="section">
        <ContentColumn>
          ...
          <p>
            ...
            que très peu de contre-indications. Lors de notre première séance,
            une anamnèse est faite dont les conclusions permettent d’adapter
            votre prise en charge selon votre problématique. Selon vos besoins
            et attentes, nous utiliserons différentes techniques de soins.
          </p>

          <Heading level={2}>Pour quels maux ?</Heading>

          <p className="my-2">
            Voici une liste non exhaustive de maux que la médecine
            traditionnelle chinoise peut prendre en charge.
          </p>
          ...
          <p className="my-2">
            ...
            Vietnam. Elle s’appuie sur différents principes tirés de
            l’observation de la nature à l’exemple des 5 éléments ou le yin et
            le yang.
          </p>
          <p className="my-2">
            L’objectif de cette médecine est la recherche de l’équilibre et
            l’harmonie des énergies qui circulent dans le corps par les
            méridiens. S’agissant d’une médecine holistique, l’harmonie
            s’applique à l’énergie mais aussi l’esprit, le corps ou la
            diététique. La médecine chinoise possède un arsenal thérapeutique
            varié, tels que l’acupuncture, les ventouses, la moxibustion ou le
            massage Tui Na. Ces différentes techniques sont utilisées selon vos
            besoins, attentes ou éventuelles craintes des aiguilles.
          </p>
          ...
          <p className="my-2">
            ...
            jetables) sont insérées sur des points spécifiques qui parcourent
            les méridiens. Ces points d’acupuncture permettent de stimuler
            l’énergie ou de la faire circuler selon le besoin. Lors d’une
            séance, les aiguilles appliquées restent en place environ 30 minutes
            selon les problématiques. Ce laps de temps permet d’utiliser
            d’autres techniques manuelles par exemple, ou simplement de se
            relaxer.
          </p>
          ...
          <p className="my-2">
            ...
            en Europe jusqu’au 20e siècle. L’intérêt des ventouses est de
            stimuler des points d’acupuncture sans utiliser d’aiguilles ainsi
            que de chasser les pathogènes. La méthode consiste à flamber
            l’intérieur d’une ventouse en verre ou en bambou avant de
            l’appliquer sur la peau. Le vide d’air créer une aspiration des
            tissus superficiels permettant un effet énergétique mais aussi
            mécanique d’assouplissement de la peau et des muscles.
          </p>
          ...
          <p className="my-2">
            ...
            point d’acupuncture en le réchauffant. Le moxa est issu d’une
            plante, l’armoise chinoise, conditionné sous forme de bâton, de cône
            à encens ou de feuilles séchées. Après avoir allumé le moxa,
            celui-ci est rapproché de la peau ou appliquer sur du gingembre pour
            ne pas brûler la peau. La chaleur agréable dégagée permet de traiter
            différents maux durant nos séances en cabinet mais aussi vous-même à
            la maison, par exemple pour les femmes enceintes dont le bébé est en
            siège.
          </p>
