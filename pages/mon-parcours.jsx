      ...
      <ContentRow tag="section">
        <ContentColumn>
          ...
          <p className="my-2">
            ...
            professionnels tel que la relève du{' '}
            <em>Genève-Servette Hockey Club</em>.
          </p>

          <p className="my-2">
            Après ces expériences, j’ai rapidement entamé mon cursus de
            formation en médecine traditionnelle chinoise pour lequel j’ai
            obtenu mon diplôme auprès du{' '}
          ...
          <p className="my-2">
            Aujourd’hui, j’ai la chance de pouvoir vous accueillir en cabinet
            pour des traitements d’acupuncture ou de venir directement chez vous
            si besoin.
          </p>

          <p className="my-2">
            En plus de l’acupuncture, je poursuis également mon activité de
            physiothérapeute aux <em>Hôpitaux Universitaires de Genève</em> où
            je prends en charge des patients ayant subi des accidents ou
